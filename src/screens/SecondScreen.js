    ...
    return <>
        ...
        <div className={styles.row}>
            ...
            <Bonus 
                ...
                description="את כבר מותשת מלתקן את האודם כל כמה שעות, והמראה הטבעי שאת מחפשת נעלם. גם כנשים דתיות, ההתעסקות המתמדת באיפור מכבידה"
                icon={lipstick}
            />
            <Bonus 
                title="זמנים ארוכים מול המראה בבוקר" 
                description="את משקיעה זמן רב מדי בניסיון להשיג מראה מושלם, והתוצאה עדיין לא מספקת. הגיע הזמן למצוא פתרון קבוע"
                icon={mirror}
            />
            <Bonus 
                title="טיפול קודם שהשאיר טעם רע" 
                description="הטיפול הקודם אצל מישהי אחרת השאיר אותך מאוכזבת ומתוסכלת. איבדת אמון במטפלות ואת חוששת לנסות שוב"
                icon={brush}
            />
        </div>
